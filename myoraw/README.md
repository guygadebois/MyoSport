...
This subfolder contains the "myo-raw" project (Copyright (c) 2014 Danny Zhu),
available at https://github.com/dzhu/myo-raw
It has been slightly modified for the needs of MyoSport's project.
Thereby, It could not be simply included via a git submodule.
